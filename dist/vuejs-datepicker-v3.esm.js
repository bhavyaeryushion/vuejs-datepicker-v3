...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", {
    class: normalizeClass({'input-group' : $props.bootstrapStyling})
  }, [
    createCommentVNode(" Calendar Button "),
    ($props.calendarButton)
      ? (openBlock(), createElementBlock("span", {
          key: 0,
          class: normalizeClass(["vdp-datepicker__calendar-button", {'input-group-prepend' : $props.bootstrapStyling}]),
          onClick: _cache[0] || (_cache[0] = (...args) => ($options.showCalendar && $options.showCalendar(...args))),
          style: normalizeStyle({'cursor:not-allowed;' : $props.disabled})
        }, [
          createElementVNode("span", {
            class: normalizeClass({'input-group-text' : $props.bootstrapStyling})
          }, [
            createElementVNode("i", {
              class: normalizeClass($props.calendarButtonIcon)
            }, [
              createTextVNode(toDisplayString($props.calendarButtonIconContent) + " ", 1 /* TEXT */),
    ...
    ($props.clearButton && $props.selectedDate)
      ? (openBlock(), createElementBlock("span", {
          key: 1,
          class: normalizeClass(["vdp-datepicker__clear-button", {'input-group-append' : $props.bootstrapStyling}]),
  ...
  return withDirectives((openBlock(), createElementBlock("div", {
    ...
    createElementVNode("header", null, [
      createElementVNode("span", {
        ...
        class: normalizeClass(["prev", {'disabled': $options.isLeftNavDisabled}])
      }, "<", 2 /* CLASS */),
      createElementVNode("span", {
      ...
      }, toDisplayString($options.isYmd ? $options.currYearName : $options.currMonthName) + " " + toDisplayString($options.isYmd ? $options.currMonthName : $options.currYearName), 3 /* TEXT, CLASS */),
      createElementVNode("span", {
        onClick: _cache[2] || (_cache[2] = $event => ($props.isRtl ? $options.previousMonth() : $options.nextMonth())),
        class: normalizeClass(["next", {'disabled': $options.isRightNavDisabled}])
      }, ">", 2 /* CLASS */)
    ]),
    createElementVNode("div", {
      class: normalizeClass($props.isRtl ? 'flex-rtl' : '')
    }, [
      (openBlock(true), createElementBlock(Fragment, null, renderList($options.daysOfWeek, (d) => {
      ...
      ($options.blankDays > 0)
        ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList($options.blankDays, (d) => {
            return (openBlock(), createElementBlock("span", {
        ...
        : createCommentVNode("v-if", true),
      createCommentVNode("\n      "),
      (openBlock(true), createElementBlock(Fragment, null, renderList($options.days, (day) => {
        return (openBlock(), createElementBlock("span", {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createElementBlock("div", {
    ...
    createElementVNode("header", null, [
      ...
      }, toDisplayString($options.pageYearName), 3 /* TEXT, CLASS */),
      createElementVNode("span", {
        onClick: _cache[2] || (_cache[2] = $event => ($props.isRtl ? $options.previousYear() : $options.nextYear())),
        class: normalizeClass(["next", {'disabled': $options.isRightNavDisabled}])
      }, ">", 2 /* CLASS */)
    ]),
    (openBlock(true), createElementBlock(Fragment, null, renderList($options.months, (month) => {
      return (openBlock(), createElementBlock("span", {
        class: normalizeClass(["cell month", {'selected': month.isSelected, 'disabled': month.isDisabled}]),
        key: month.timestamp,
        onClick: withModifiers($event => ($options.selectMonth(month)), ["stop"])
      }, toDisplayString(month.month), 11 /* TEXT, CLASS, PROPS */, _hoisted_1$1))
    }), 128 /* KEYED_FRAGMENT */))
  ], 38 /* CLASS, STYLE, NEED_HYDRATION */)), [
    [vShow, $props.showMonthView]
  ])
}
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createElementBlock("div", {
    ...
    createElementVNode("header", null, [
      ...
      createElementVNode("span", null, toDisplayString($options.getPageDecade), 1 /* TEXT */),
      createElementVNode("span", {
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($options.years, (year) => {
      return (openBlock(), createElementBlock("span", {
        class: normalizeClass(["cell year", { 'selected': year.isSelected, 'disabled': year.isDisabled }]),
        key: year.timestamp,
        onClick: withModifiers($event => ($options.selectYear(year)), ["stop"])
      }, toDisplayString(year.year), 11 /* TEXT, CLASS, PROPS */, _hoisted_1))
    }), 128 /* KEYED_FRAGMENT */))
  ], 38 /* CLASS, STYLE, NEED_HYDRATION */)), [
    [vShow, $props.showYearView]
  ])
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    createVNode(_component_date_input, {
      ...
      default: withCtx(() => [
        renderSlot(_ctx.$slots, "afterDateInput", { slot: "afterDateInput" })
      ]),
      _: 3 /* FORWARDED */
    ...
    ($options.allowedToShowView('day'))
      ? (openBlock(), createBlock(_component_picker_day, {
          ...
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "beforeCalendarHeader", { slot: "beforeCalendarHeader" })
          ]),
          _: 3 /* FORWARDED */
